...
blocking fd handle for existing runtime compatibility.
...
- `src/lisp/tests_tests.c3`
  ...
  - Kept legacy generic matcher (`scheduler_runtime_boundary_fields_match`) as the underlying primitive used by the snapshot helper.
