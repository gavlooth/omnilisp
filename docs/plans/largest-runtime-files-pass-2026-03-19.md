...
- `src/lisp/jit_jit_apply_multi_prims.c3` →
  ...
  - `jit_jit_apply_multi_prims.c3`: `230`
  - `jit_jit_apply_multi_prims_tail.c3`: `201`
...
- `src/lisp/jit_jit_handle_signal_helpers.c3` →
  `src/lisp/jit_jit_handle_signal_helpers_continuation_scan.c3` +
  `src/lisp/jit_jit_handle_signal_helpers_runtime_effects.c3`
  - `jit_jit_handle_signal_helpers.c3`: `188`
  - `jit_jit_handle_signal_helpers_continuation_scan.c3`: `143`
  - `jit_jit_handle_signal_helpers_runtime_effects.c3`: `116`
