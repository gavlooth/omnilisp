...
```text
OMNI_BENCH_SUMMARY suite=boundary_decision_cost iters=2048 splice_ms=27 disallowed_ms=15 reuse_ms=5 splice_ok=2048 disallowed_ok=2048 reuse_ok=2048
...
OMNI_BENCH_SUMMARY suite=equality_nested_workspace iters=2048 fixture_ok=1 list_depth=1024 array_len=1024 list_true_ms=2121 list_true_ok=2048 list_false_ms=2121 list_false_ok=2048 array_true_ms=48 array_true_ok=2048 array_false_ms=47 array_false_ok=2048 mixed_true_ms=604 mixed_true_ok=2048 mixed_false_ms=573 mixed_false_ok=2048 stack_growth=0 seen_growth=0 stack_bytes=0 seen_bytes=0
...
- Boundary materialization copy debt is zero in this benchmark profile:
  ...
  `materialization_copy_bytes=0` in the boundary-decision summary. No new
  copy-reduction optimization is justified from this baseline alone.
