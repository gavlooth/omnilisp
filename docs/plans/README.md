...
- `memory-boundary-proof-planner-roadmap-2026-04-24.md`: active roadmap for
  ...
  under `MEM-BOUNDARY-FFI-BRIDGE-001` through
  `MEM-BOUNDARY-PLAN-MIGRATE-001`; `MEM-BOUNDARY-PLANNER-001`,
  `MEM-BOUNDARY-PASSPORT-001`, `MEM-BOUNDARY-EPOCH-001`, and
  `MEM-BOUNDARY-TRANSPLANT-001` are closed.
