# tensor-scientific-computing-plan-2026-04-11 Index

`docs/plans/tensor-scientific-computing-plan-2026-04-11.md` remains the canonical entrypoint. The original content was split mechanically into the indexed part files below to keep every project-owned documentation file under 700 lines. Content order is preserved.
