...
src/lisp/tests_memory_lifetime_boundary_graph_txn_bench_groups.c3:75:            Value* escape_root = promote_to_escape(temp_list, interp);
src/lisp/tests_memory_lifetime_boundary_graph_txn_bench_groups.c3:1323:            Value* escaped_first = promote_to_escape(make_int(interp, (long)(i + 501)), interp);
src/lisp/tests_memory_lifetime_boundary_graph_txn_bench_groups.c3:1324:            Value* escaped_second = promote_to_escape(make_int(interp, (long)(i + 901)), interp);
