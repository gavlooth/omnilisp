...
Archived from `TODO.md` on 2026-03-31 after the live backlog reached zero
open items. This snapshot preserves the fully completed queue that was in the
active backlog immediately before cleanup.
