# Omni Lisp to C3 Compiler

This document describes the Omni Lisp compiler that translates Lisp source code to C3 source code for native execution.
...
```c3
// Generated by Omni Lisp Compiler
