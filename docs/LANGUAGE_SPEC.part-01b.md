...
`max-scalar-f32`, `scalar-sub-f32`, and `scalar-div-f32` over dense row-major
`Float32` tensors. Arbitrary backend source compilation and fusion remain
fail-closed.
