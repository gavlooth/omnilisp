...
are checked Vulkan `scale-f32` and `add-f32` over dense row-major `Float32`
tensors; arbitrary backend source compilation and fusion remain fail-closed.
