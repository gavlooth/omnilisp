# tensor-scientific Index

`docs/areas/tensor-scientific.md` remains the canonical entrypoint. The original content was split mechanically into the indexed part files below to keep every project-owned documentation file under 700 lines. Content order is preserved.
