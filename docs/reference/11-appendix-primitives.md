...
| `kernel/run` | 3 | Explicit custom kernel execution entrypoint; supports checked Vulkan `scale-f32` `Float32` tensor kernels and fails closed for unsupported backend compilation/execution |
