...
| `ml/optimizer-step` | 4 | Data-oriented optimizer spec step; currently supports CPU SGD with optional momentum and weight decay over explicit parameter/state trees |
