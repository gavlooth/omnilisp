...
| `ml/optimizer-step` | 4 | Data-oriented optimizer spec step; currently supports CPU SGD, Adam, AdamW, and RMSProp plus all-Vulkan Float32 SGD over explicit parameter/state trees |
