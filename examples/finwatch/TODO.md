...
- [x] `alerts.omni`      — price/analytics alert tutorial, custom effects, handle composition, alert dispatch
...
- [x] `Iterator` / `next` / `range-from` — lazy iterator sequences (events.omni, smoke_test)
