...
sources=(
  ...
  "csrc/tensor_vulkan_helpers_ml_pool.c"
  "csrc/tensor_vulkan_helpers_ml_softmax.c"
  "csrc/tensor_vulkan_helpers_ml_optimizer_f32.c"
  "csrc/tensor_vulkan_helpers_ml_optimizer_f64.c"
  "csrc/tensor_vulkan_helpers_ml_clip.c"
  "csrc/tensor_vulkan_helpers_ml_normalization.c"
  ...
  "csrc/tensor_vulkan_ml_mse_f32_spv.c"
  "csrc/tensor_vulkan_ml_mse_f64_spv.c"
  ...
  "csrc/tensor_vulkan_ml_conv1d_f32_spv.c"
  "csrc/tensor_vulkan_ml_conv2d_f32_spv.c"
  "csrc/tensor_vulkan_ml_pool2d_f32_spv.c"
  ...
  "csrc/tensor_vulkan_ml_rmsprop_f32_spv.c"
  "csrc/tensor_vulkan_ml_sgd_f64_spv.c"
  "csrc/tensor_vulkan_ml_sgd_init_momentum_f64_spv.c"
  "csrc/tensor_vulkan_ml_sgd_momentum_f64_spv.c"
  "csrc/tensor_vulkan_ml_adam_init_f64_spv.c"
  "csrc/tensor_vulkan_ml_adam_f64_spv.c"
  "csrc/tensor_vulkan_ml_rmsprop_f64_spv.c"
  "csrc/tensor_vulkan_ml_clip_sum_squares_f32_spv.c"
  "csrc/tensor_vulkan_ml_clip_scale_f32_spv.c"
  "csrc/tensor_vulkan_ml_layer_norm_f32_spv.c"
  "csrc/tensor_vulkan_ml_layer_norm_f64_spv.c"
  "csrc/tensor_vulkan_ml_batch_norm_f32_spv.c"
  "csrc/tensor_vulkan_ml_batch_norm_f64_spv.c"
  ...
  "csrc/tensor_vulkan_svd_complex128_spv.c"
  "csrc/tensor_vulkan_svd_complex64_spv.c"
  "csrc/tensor_vulkan_symmetric_eigen_f64_spv.c"
  "csrc/tensor_vulkan_hermitian_eigen_complex128_spv.c"
  "csrc/tensor_vulkan_hermitian_eigen_complex64_spv.c"
  "csrc/tensor_vulkan_general_eigen_complex128_spv.c"
  "csrc/tensor_vulkan_general_eigen_complex64_spv.c"
  "csrc/tensor_vulkan_general_eigen_f64_spv.c"
  "csrc/tensor_vulkan_general_eigen_f32_spv.c"
  "csrc/json_helpers.c"
  "csrc/tls_helpers.c"
  "csrc/uv_helpers.c"
